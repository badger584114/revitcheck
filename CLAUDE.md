...
pdfchecker/
  ...
  tests/
    ...
    test_setout_reconstruction.py  # Stage 3 (§5b): extraction/setout_reconstruction.py's
                                    ...
                                    # — plus a real-sample assertion reconstructing all 24 real
                                    # piles on samples/dxf/101051
